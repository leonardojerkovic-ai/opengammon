...
- **Otvoreno / u tijeku:**
  ...
  - **Milijunski test (`random_self_play_positions_match_gnubg`, `OG_DIFF_SAMPLE_SIZE` override) ostaje neodrađen.** Ono što je bio preduvjet (čist 10k run) je sad zadovoljeno; ostaje paralelizacija diferencijalnog runa i sam run u punoj veličini (vidi listu ispod).
