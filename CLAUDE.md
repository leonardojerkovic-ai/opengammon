...
- **Faza 2 (svjesno odstupanje od "faza po faza", dogovoreno s korisnikom 2026-09-23 — Faza 1 nije zatvorena):**
  ...
  - **Ostaje: provjeriti "lookup ispod mikrosekunde" (nije još formalno mjereno, samo O(1) po dizajnu).** Zatim natrag na Fazu 1 (milijunski run) prije nego se Faza 2 smatra "trenutnom".
